...
const features = [
  {
    ...
    description: "Real-time visibility into every vehicle and asset. Know where your team is, optimize routes, and reduce fuel costs.",
  },
  {
    icon: Wrench,
    title: "Field Service Management",
    description: "Schedule, dispatch, and manage jobs from one place. From work orders to invoicing—streamlined.",
  },
  {
    icon: MessageSquare,
    title: "Customer Communication",
    description: "Unified inbox for calls, texts, and reviews. Never miss a lead or leave a customer waiting.",
  },
  {
    icon: Brain,
    title: "AI Assistants",
    description: "Intelligent agents that manage conversations, automate workflows, and surface insights in real time.",
  },
];
...
const benefits = [
  {
    ...
    description: "See every vehicle, technician, and job in real time across your entire operation.",
  },
  {
    icon: Zap,
    title: "Intelligent Automation",
    description: "AI handles scheduling conflicts, customer follow-ups, and routine decisions automatically.",
  },
  {
    icon: TrendingUp,
    title: "Accelerated Growth",
    description: "Close more jobs, improve reviews, and scale without adding back-office overhead.",
  },
  {
    icon: Shield,
    title: "Enterprise-Grade, SMB-Friendly",
    description: "Advanced technology without enterprise cost, contracts, or complexity.",
  },
  {
    icon: Clock,
    title: "Dispatch to Completion",
    description: "End-to-end workflow from job assignment to completion to customer follow-up.",
  },
  {
    icon: Users,
    title: "Team Accountability",
    description: "Track performance, ensure quality, and empower your team with better data.",
  },
];
        ...
        <div className="container relative mx-auto px-4 pt-20 pb-16 lg:px-8 lg:pt-32 lg:pb-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.h1
              ...
              className="font-heading text-4xl md:text-5xl lg:text-7xl font-bold text-foreground leading-[1.1] tracking-tight"
            >
              One platform to{" "}
          ...
          >
            <div className="rounded-xl border border-border/50 overflow-hidden glow-primary">
              <img
                src={heroDashboard}
                alt="Newco platform dashboard showing fleet tracking and job management"
      ...
      <section className="py-24 lg:py-32">
        <div className="container mx-auto px-4 lg:px-8">
          <SectionHeading
            ...
            highlight="unified."
            description="Stop juggling disconnected tools. Newco brings fleet tracking, job management, and customer communication into one intelligent platform."
          />
        ...
        <div className="container relative mx-auto px-4 lg:px-8 text-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto">
              See how Newco can reduce manual work, improve accountability, and accelerate your growth.
            </p>
            <div className="mt-10">
              <Link to="/contact">
