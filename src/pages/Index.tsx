    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-hero-gradient">
        ...
        <div className="container relative mx-auto px-4 pt-20 pb-16 lg:px-8 lg:pt-32 lg:pb-24">
          ...
          <div
            className="animate-fade-up mt-16 lg:mt-24 max-w-5xl mx-auto"
            style={{ animationDelay: "0.5s", animationFillMode: "both" }}
          >
            <div className="rounded-xl border border-border/50 overflow-hidden glow-primary">
              <img src={heroDashboard} alt="Servinix platform dashboard showing fleet tracking and job management" className="w-full h-auto" loading="eager" width="1920" height="1080" />
            </div>
          </div>
        </div>
      </section>
      ...
      <Suspense fallback={
        <section className="py-24 lg:py-32">
          <div className="container mx-auto px-4 lg:px-8">
            <SectionHeading badge="Platform" title="Everything your service business needs," highlight="unified." description="Stop juggling disconnected tools." />
          </div>
        </section>
      }>
        <LazyMotionSections features={features} benefits={benefits} industries={industries} testimonials={testimonials} faqs={faqs} />
      </Suspense>
    </Layout>
  );
};
