        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="font-heading text-2xl font-bold text-foreground mb-8">Request a Demo</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="lastName" placeholder="Smith" required className="bg-background border-border" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="company" placeholder="Acme Services" required className="bg-background border-border" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="fleet" className="text-foreground">Fleet Size</Label>
                  <Input id="fleet" placeholder="e.g. 10-50 vehicles" className="bg-background border-border" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-foreground">Message (optional)</Label>
                  <Textarea id="message" placeholder="Tell us about your business..." rows={4} className="bg-background border-border" />
                </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:pt-12">
              ...
              <div className="space-y-8">
                {[
                  { icon: Mail, title: "Email", detail: "hello@servinix.com" },
                  { icon: Phone, title: "Phone", detail: "Contact us for details" },
                  { icon: MapPin, title: "Headquarters", detail: "United States" },
                ].map((item) => (
              ...
              <div className="mt-12 rounded-xl border border-border/50 bg-card-gradient p-8">
                <h3 className="font-heading text-lg font-semibold text-foreground mb-3">What to expect</h3>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex gap-2"><span className="text-primary font-bold">1.</span>We'll reach out within 24 hours</li>
                  <li className="flex gap-2"><span className="text-primary font-bold">2.</span>A personalized demo of the Servinix platform</li>
                  <li className="flex gap-2"><span className="text-primary font-bold">3.</span>Custom pricing based on your business needs</li>
                </ul>
              </div>
            </motion.div>
          </div>
